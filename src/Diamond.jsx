...
function Diamond() {
  const { plans, setplans, cart, SetCart, currentUser } = useAuth();
  ...
  return (
    <div>
      ...
      <br></br>
      <br></br>
      <h1 className="text-center text-info display-4">Diamond Package</h1>

      <div class="container mt-xl-5 mt-lg-5 mt-md-5">
                ...
                <div className="card shadow-sm">
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-flex justify-content-between align-items-center mt-4">
                      ...
                      <small className="text-muted">For 15 Days</small>
                    </div>
                  </div>
                </div>
              </div>
